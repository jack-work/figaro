...
var inputOracle = []struct {
	...
	{"incipit", "stop=false rest=\"\" act=false off=0 fol=false srch=false q=\"\" h=false s=false Q=false g=false sel=false verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false", map[string]string{
		...
		"0x6b":            "stop=false rest=\"\" act=true off=740 fol=false srch=false q=\"\" h=false s=false Q=false g=false sel=false verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false",
		...
		"nav:Up":          "stop=false rest=\"\" act=true off=740 fol=false srch=false q=\"\" h=false s=false Q=false g=false sel=false verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false",
	}},
