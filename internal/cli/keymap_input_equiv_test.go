...
var inputOracle = []struct {
	...
	{"panel", "stop=false rest=\"\" act=true off=742 fol=true srch=false q=\"\" h=false s=false Q=false g=false sel=false verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false", map[string]string{
		...
		"alt ^p fallback": "stop=false rest=\"\" act=true off=762 fol=false srch=false q=\"\" h=true s=false Q=false g=false sel=true verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false",
		...
		"csiu ^p":         "stop=false rest=\"\" act=true off=762 fol=false srch=false q=\"\" h=true s=false Q=false g=false sel=true verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false",
		"csiu ^p+alt":     "stop=false rest=\"\" act=true off=762 fol=false srch=false q=\"\" h=true s=false Q=false g=false sel=true verb=false disc=0 canc=false clip=\"\" cpfail=false cping=false",
