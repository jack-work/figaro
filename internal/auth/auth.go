...
type StoredCredentials struct {
	...
	ExpiresAt    int64  `toml:"expires_at"`    // unix millis, plaintext
}
...
func (m *TokenManager) readCredentials() (*StoredCredentials, error) {
	...
	if creds.AccessToken == "" {
		return nil, fmt.Errorf("no credentials in %s", m.filePath)
	}
	return &creds, nil
}
...
func (m *TokenManager) saveTokens(accessToken, refreshToken string, expiresIn int) error {
	...
	buf.WriteString("# Auto-generated by figaro login. Do not edit.\n")
